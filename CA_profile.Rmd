...
CA_data = read_rds(paste0("temp/",params$area,"-content.rds"))

list2env(CA_data, envir = environment())
...
# there's one function in this file but it's used inline 
# at some point so is required to be loaded
source("functions folder/text_functions.R", local = T)
