...
### `r bir_est_end_year` Births by Council Area in Scotland
...
current_births <-
  ...
  total_births_sex$Year == bir_est_end_year]
  
  previous_births <-
  total_births_sex$Number[total_births_sex$Sex == "All people" &
  total_births_sex$Year == bir_est_end_year - 1]
...
current_birth_rate <- births_rate$Number[births_rate$Area == paramsarea & births_rate$Year == bir_est_end_year]

previous_birth_rate <- births_rate$Number[births_rate$Area == paramsarea & births_rate$Year == bir_est_end_year - 1]

current_birth_rate_scotland <- births_rate$Number[births_rate$Area == "Scotland" & births_rate$Year == bir_est_end_year]

previous_birth_rate_scotland <- births_rate$Number[births_rate$Area == "Scotland" & births_rate$Year == bir_est_end_year - 1]
...
`r ifelse(current_birth_rate > previous_birth_rate, paste0("increased from ",formatC(previous_birth_rate, format='f', digits=1), " per 1,000 population in ",bir_est_end_year - 1, " to ",formatC(current_birth_rate, format='f', digits=1)," in ", bir_est_end_year), ifelse(current_birth_rate < previous_birth_rate, paste0("decreased from ",formatC(previous_birth_rate, format='f', digits=1), " per 1,000 population in ",bir_est_end_year - 1, " to ",formatC(current_birth_rate, format='f', digits=1)," in ", bir_est_end_year), paste0("in ",bir_est_end_year - 1," was ",formatC(previous_birth_rate, format='f', digits=1), " per 1,000 population and remained the same in ",bir_est_end_year)))`. In comparison, the rate in Scotland overall
`r ifelse(current_birth_rate_scotland > previous_birth_rate_scotland, paste0("increased from ",formatC(previous_birth_rate_scotland, format='f', digits=1)," to ",formatC(current_birth_rate_scotland, format='f', digits=1)), ifelse(current_birth_rate_scotland < previous_birth_rate_scotland, paste0("decreased from ",formatC(previous_birth_rate_scotland, format='f', digits=1)," to ",formatC(current_birth_rate_scotland, format='f', digits=1)), paste0("in ",bir_est_end_year - 1," was ",formatC(previous_birth_rate_scotland, format='f', digits=1), " and remained the same in ",bir_est_end_year)))`. 
...
mothers_age_most_common_current <-
  total_births_mothers_age_plot$Age_group[total_births_mothers_age_plot$Year == bir_est_end_year &
  total_births_mothers_age_plot$Area == paramsarea &
  total_births_mothers_age_plot$Number == max(total_births_mothers_age_plot$Number[total_births_mothers_age_plot$Year == bir_est_end_year &
  total_births_mothers_age_plot$Area == paramsarea])]
  ...
  total_births_mothers_age_plot$Year == bir_est_end_year &
  total_births_mothers_age_plot$Area == paramsarea]
  
  mothers_age_most_common_previous <-
  total_births_mothers_age_plot$Age_group[total_births_mothers_age_plot$Year == bir_est_start_year &
  total_births_mothers_age_plot$Area == paramsarea &
  total_births_mothers_age_plot$Number == max(total_births_mothers_age_plot$Number[total_births_mothers_age_plot$Year == bir_est_start_year &
  total_births_mothers_age_plot$Area == paramsarea])]
  
  mothers_age_least_common_current <-
  total_births_mothers_age_plot$Age_group[total_births_mothers_age_plot$Year == bir_est_end_year &
  total_births_mothers_age_plot$Area == paramsarea &
  total_births_mothers_age_plot$Number == min(total_births_mothers_age_plot$Number[total_births_mothers_age_plot$Year == bir_est_end_year &
  total_births_mothers_age_plot$Area == paramsarea])]
  ...
  total_births_mothers_age_plot$Age_group[total_births_mothers_age_plot$Year == bir_est_start_year &
  total_births_mothers_age_plot$Area == paramsarea &
  total_births_mothers_age_plot$Number == min(total_births_mothers_age_plot$Number[total_births_mothers_age_plot$Year == bir_est_start_year &
  total_births_mothers_age_plot$Area == paramsarea])]

```

  In 
`r bir_est_end_year`, the most common 
...
`r bir_est_start_year`. The least common
...
current_fert_rate <-
  ...
  fert_rate$Year == bir_est_end_year]
  
  previous_fert_rate <-
  fert_rate$Number[fert_rate$Area == paramsarea &
  fert_rate$Year == bir_est_end_year - 1]
...
`r params$area` 
`r ifelse(current_fert_rate > previous_fert_rate, paste0("increased from ",previous_fert_rate, " in ",bir_est_end_year - 1, " to ",current_fert_rate," in ", bir_est_end_year), ifelse(current_fert_rate < previous_fert_rate, paste0("decreased from ",previous_fert_rate, " in ",bir_est_end_year - 1, " to ",current_fert_rate," in ", bir_est_end_year), paste0("in ",bir_est_end_year - 1," was ",previous_fert_rate, " and remained the same in ",bir_est_end_year)))`. Out of the 32 council areas in Scotland, 
...
`r bir_est_end_year` and this is 
...
### `r dea_est_end_year` Deaths by Council Area in Scotland
...
current_deaths <-
  ...
  total_deaths_sex$Year == dea_est_end_year]
  
  previous_deaths <-
  total_deaths_sex$Number[total_deaths_sex$Sex == "All people" &
  total_deaths_sex$Year == dea_est_end_year - 1]
...
current_death_rate <-
  ...
  deaths_rate$Year == dea_est_end_year]
  
  previous_death_rate <-
  deaths_rate$Number[deaths_rate$Area == paramsarea &
  deaths_rate$Year == dea_est_end_year - 1]
...
`r ifelse(current_death_rate > previous_death_rate, paste0("increased from ",formatC(previous_death_rate, format='f', digits=1), " per 1,000 population in ",dea_est_end_year - 1, " to ",formatC(current_death_rate, format='f', digits=1)," in ", dea_est_end_year), ifelse(current_death_rate < previous_death_rate, paste0("decreased from ",formatC(previous_death_rate, format='f', digits=1), " per 1,000 population in ",dea_est_end_year - 1, " to ",formatC(current_death_rate, format='f', digits=1)," in ", dea_est_end_year), paste0("in ",dea_est_end_year - 1," was ",formatC(previous_death_rate, format='f', digits=1), " per 1,000 population and remained the same in ",dea_est_end_year)))`. In comparison, the rate in Scotland overall
`r ifelse(current_death_rate_scotland > previous_death_rate_scotland, paste0("increased from ",formatC(previous_death_rate_scotland, format='f', digits=1)," to ",formatC(current_death_rate_scotland, format='f', digits=1)), ifelse(current_death_rate_scotland < previous_death_rate_scotland, paste0("decreased from ",formatC(previous_death_rate_scotland, format='f', digits=1)," to ",formatC(current_death_rate_scotland, format='f', digits=1)), paste0("in ",dea_est_end_year - 1," was ",formatC(previous_death_rate_scotland, format='f', digits=1), " and remained the same in ",dea_est_end_year)))`. 

In 
`r dea_est_end_year`, 
`r paramsarea` was the council area with the 
`r deaths_rate_rank_text` standardised death rate. Between 
`r dea_est_end_year - 1` and 
`r dea_est_end_year`, 
...
deaths_change_type_f <-
  ...
  total_deaths_sex_comp$Year == dea_est_end_year]
...
```
  ...
  In comparison to 
`r dea_est_start_year`, the number of female deaths registered in
`r paramsarea` in
`r dea_est_end_year` was
...
### `r marr_est_end_year` Marriages by Council Area in Scotland
...
current_marr <- total_marr$Number[total_marr$Area == paramsarea & total_marr$Year == marr_est_end_year]

previous_marr <- total_marr$Number[total_marr$Area == paramsarea & total_marr$Year == marr_est_end_year - 1]

marr_perc <- (current_marr - previous_marr)/previous_marr*100

current_marr_scotland <- total_marr$Number[total_marr$Area == "Scotland" & total_marr$Year == marr_est_end_year]

previous_marr_scotland <- total_marr$Number[total_marr$Area == "Scotland" & total_marr$Year == marr_est_end_year - 1]
...
`r marr_est_end_year - 1`. In comparison, the number of marriages registered in Scotland overall 
...
`r marr_est_end_year`, out of the 32 council areas in Scotland. Between 
`r marr_est_end_year - 1` and 
`r marr_est_end_year`, 
...
### `r cp_est_end_year` Civil Partnerships by Council Area in Scotland
...
current_cp <- total_cp$Number[total_cp$Area == paramsarea & total_cp$Year == cp_est_end_year]

previous_cp <- total_cp$Number[total_cp$Area == paramsarea & total_cp$Year == cp_est_end_year - 1]

cp_perc <- (current_cp - previous_cp)/previous_cp*100

cp_f <- data_cp_gender$Number[data_cp_gender$Area == paramsarea & data_cp_gender$Year == cp_est_end_year & data_cp_gender$Sex == "Female"]

cp_m <- data_cp_gender$Number[data_cp_gender$Area == paramsarea & data_cp_gender$Year == cp_est_end_year & data_cp_gender$Sex == "Male"]

current_cp_scotland <- total_cp$Number[total_cp$Area == "Scotland" & total_cp$Year == cp_est_end_year]

previous_cp_scotland <- total_cp$Number[total_cp$Area == "Scotland" & total_cp$Year == cp_est_end_year - 1]
...
`r cp_est_end_year`, which is
`r ifelse(cp_perc_scotland < 0, paste0("a decrease of ",formatC(round(abs(cp_perc_scotland), 1), format = "f", digits = 1),"% from ",cp_est_end_year-1), ifelse(cp_perc_scotland > 0, paste0("an increase of ",formatC(round(abs(cp_perc_scotland), 1), format = "f", digits = 1),"% from ",cp_est_end_year-1), paste0("the same as the number in ",cp_est_end_year-1)))`.
<br>
...
`r cp_est_end_year`, out of the 32 council areas in Scotland. Between 
`r cp_est_end_year - 1` and 
`r cp_est_end_year`, 
...
#### Births by sex, `r paramsarea`, `r bir_est_start_year`-`r bir_est_end_year`
...
#### Standardised birth rates, `r paramsarea`, `r bir_est_start_year`-`r bir_est_end_year`
...
#### Births by age group of mother, `r paramsarea`, `r bir_est_start_year` and `r bir_est_end_year`
...
#### Approximated total fertility rate, `r paramsarea`, `r bir_est_start_year`-`r bir_est_end_year`
...
#### Deaths by sex, `r paramsarea`, `r dea_est_start_year`-`r dea_est_end_year`
...
#### Standardised death rates, `r paramsarea`, `r dea_est_start_year`-`r dea_est_end_year`
...
#### Deaths by sex, `r paramsarea`, `r dea_est_start_year` and `r dea_est_end_year`
...
#### Deaths by age group by sex, `r paramsarea`, `r dea_est_end_year`
...
**Source:** [Vital Events Reference Tables `r dea_est_end_year`, Section 5: Deaths](https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/vital-events/general-publications/vital-events-reference-tables/2018/section-5-deaths) Table 5.02
...
#### Male leading causes of death, `r paramsarea`, `r dea_est_end_year`
...
**Source:** [Vital Events Reference Tables `r dea_est_end_year`, Section 6: Deaths - Causes](https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/vital-events/general-publications/vital-events-reference-tables/2019/list-of-data-tables#section6) Table 6.03
...
#### Female leading causes of death, `r paramsarea`, `r dea_est_end_year`
...
### `r marr_est_end_year` Marriages and Civil Partnerships by Council Area in Scotland

<br>

<a name="table_marr"></a>

#### Total marriages, `r paramsarea`, `r marr_est_start_year`-`r marr_est_end_year`
...
#### Total civil partnerships, `r paramsarea`, `r cp_start_year`-`r cp_est_end_year`
