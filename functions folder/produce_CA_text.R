produce_CA_text <- function(CA_env) {
  ...
  # PURPOSE OF SCRIPT: Create text for Council Area Profiles
  # CONTACTS:          joseph.adams@nrscotland.gov.uk
  # SOURCES:           Council Area Profiles
  # NOTES:             This is a work in progress - to simplify the Rmarkdown file
