...
require(ggrepel) # Direct labelling whilst avoiding overlapping text
require(grid)
...
source('NRS-Website-Council_Area_Profiles-2018_update-2-Data_preparation.R')
source('NRS-Website-Council_Area_Profiles-2018_update-3-Plots.R')
source('NRS-Website-Council_Area_Profiles-2018_update-4-Tables.R')

```

<img src="NRS_logo_colour.png" width="300px" style="position:absolute;top:0px;right:0px;padding:20px; " />
...
``` {r pop_est_text1, echo=FALSE}

current_pop_est <- total_pop_est$Number[total_pop_est$Area == paramsarea & total_pop_est$Year == pop_est_end_year]

previous_pop_est <- total_pop_est$Number[total_pop_est$Area == paramsarea & total_pop_est$Year == (pop_est_end_year - 1)]

pop_est_perc <- (current_pop_est - previous_pop_est)/previous_pop_est*100

current_pop_est_scot <- total_pop_est$Number[total_pop_est$Area == "Scotland" & total_pop_est$Year == pop_est_end_year]

previous_pop_est_scot <- total_pop_est$Number[total_pop_est$Area == "Scotland" & total_pop_est$Year == (pop_est_end_year - 1)]

pop_est_perc_scot <- (current_pop_est_scot - previous_pop_est_scot)/previous_pop_est_scot*100
...
<div class = "col-md-3">
 ...
 On 30 June
`r pop_est_end_year`, the population of
`r paramsarea` was 
`r format(current_pop_est, big.mark=",")`. This is 
`r ifelse(previous_pop_est > current_pop_est, paste0("a decrease of ",formatC(round(abs(pop_est_perc), 1), format='f', digits=1),"% from ",format(previous_pop_est, big.mark=",")," in"), ifelse(previous_pop_est < current_pop_est, paste0("an increase of ",formatC(round(abs(pop_est_perc), 1), format='f', digits=1),"% from ",format(previous_pop_est, big.mark=",")," in"), "unchanged from"))`
`r pop_est_end_year - 1`. Over the same period, the population of Scotland 
`r ifelse(previous_pop_est_scot > current_pop_est_scot, paste0("decreased by ",formatC(round(abs(pop_est_perc_scot), 1), format='f', digits=1),"%"), ifelse(previous_pop_est_scot < current_pop_est_scot, paste0("increased by ",formatC(round(abs(pop_est_perc_scot), 1), format='f', digits=1),"%"), paste0("did not change between ",pop_est_end_year-1," and ",pop_est_end_year)))`.
<br>
...
``` {r pop_est_text2, echo=FALSE}

pop_est_perc <- total_pop_est_end_year$Perc[total_pop_est_end_year$Area == paramsarea]

pop_est_rank_ca <- total_pop_est_end_year$Rank[total_pop_est_end_year$Area == paramsarea]

pop_est_rank_text <- ifelse(pop_est_rank_ca == min(total_pop_est_end_year$Rank), paste0("highest"), 
ifelse(pop_est_rank_ca == min(total_pop_est_end_year$Rank)+1, paste0("2nd highest"),
ifelse(pop_est_rank_ca == max(total_pop_est_end_year$Rank), paste0("lowest"), 
ifelse(pop_est_rank_ca == max(total_pop_est_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(pop_est_rank_ca == "22", paste0(pop_est_rank_ca, "nd highest"),
ifelse(pop_est_rank_ca %in% c("3","23"), paste0(pop_est_rank_ca, "rd highest"),
ifelse(pop_est_rank_ca == "21", paste0(pop_est_rank_ca, "st highest"),               
paste0(pop_est_rank_ca, "th highest"))))))))

pop_est_rank_diff_ca <- total_pop_est_end_year$Rank_change[total_pop_est_end_year$Area == paramsarea]
  
pop_est_rank_difference_text <- ifelse(pop_est_rank_diff_ca == min(total_pop_est_end_year$Rank_change), paste0("highest"), 
ifelse(pop_est_rank_diff_ca == min(total_pop_est_end_year$Rank_change)+1, paste0("2nd highest"),
ifelse(pop_est_rank_diff_ca == max(total_pop_est_end_year$Rank_change), paste0("lowest"), 
ifelse(pop_est_rank_diff_ca == max(total_pop_est_end_year$Rank_change)-1, paste0("2nd lowest"),
ifelse(pop_est_rank_diff_ca == "22", paste0(pop_est_rank_diff_ca, "nd highest"),
ifelse(pop_est_rank_diff_ca %in% c("3","23"), paste0(pop_est_rank_diff_ca, "rd highest"),
ifelse(pop_est_rank_diff_ca == "21", paste0(pop_est_rank_diff_ca, "st highest"),               
paste0(pop_est_rank_diff_ca, "th highest"))))))))

num_pop_est_increase <- nrow(total_pop_est_end_year[total_pop_est_end_year$Change_type=="increase",])
num_pop_est_decrease <- nrow(total_pop_est_end_year[total_pop_est_end_year$Change_type=="decrease",])
num_pop_est_equal <- nrow(total_pop_est_end_year[total_pop_est_end_year$Change_type=="equal",])

pop_est_scot_perc <- total_pop_est$Perc[total_pop_est$Year == pop_est_end_year & total_pop_est$Area == "Scotland"]

```

`r paramsarea` had the 
`r ifelse(length(total_pop_est_end_year$Rank[total_pop_est_end_year$Rank==pop_est_rank_ca]) > 1, paste0("joint ",pop_est_rank_text), paste0(pop_est_rank_text))` population in 
`r pop_est_end_year`, out of all 32 council areas in Scotland. Between 
`r pop_est_end_year - 1` and 
`r pop_est_end_year`, 
`r ifelse(num_pop_est_decrease == 32, paste0("all councils saw a population decrease"), ifelse(num_pop_est_increase == 32, paste0("all councils saw a population increase"), ifelse(num_pop_est_decrease == 1 & num_pop_est_increase == 1, paste0(num_pop_est_decrease," council saw a population decrease and ",num_pop_est_increase, " council saw a population increase"), ifelse(num_pop_est_increase == 1 & num_pop_est_decrease != 1, paste0(num_pop_est_decrease," councils saw a population decrease and ",num_pop_est_increase, " council saw a population increase"), ifelse(num_pop_est_increase != 1 & num_pop_est_decrease == 1, paste0(num_pop_est_decrease," council saw a population decrease and ",num_pop_est_increase, " councils saw a population increase"), paste0(num_pop_est_decrease," councils saw a population decrease and ",num_pop_est_increase," councils saw a population increase"))))))`. 
`r ifelse(num_pop_est_equal == 1, paste0("There was ",num_pop_est_equal," council that remained the same."), ifelse(num_pop_est_equal > 1, paste0("There were ",num_pop_est_equal," councils that remained the same."), ""))`  
...
Between 
`r pop_est_start_year` and
`r pop_est_end_year`, the population of 
`r paramsarea` has 
`r ifelse(pop_est_perc < 0, paste0("decreased by ",formatC(round(abs(pop_est_perc), 1), format='f', digits=1),"%"), ifelse(pop_est_perc > 0, paste0("increased by ",formatC(round(abs(pop_est_perc), 1), format='f', digits=1),"%"), paste0("remained unchanged"))) `. This is the 
`r ifelse(length(total_pop_est_end_year$Rank_change[total_pop_est_end_year$Rank_change==pop_est_rank_diff_ca]) > 1, paste0("joint ",pop_est_rank_difference_text), paste0(pop_est_rank_difference_text))` percentage change out of the 32 council areas in Scotland. Over the same period, Scotland's population 
`r ifelse(pop_est_scot_perc > 0, paste0("rose by ",formatC(round(pop_est_scot_perc, 1), format='f', digits=1),"%"), ifelse(pop_est_scot_perc < 0, paste0("fell by ",formatC(round(pop_est_scot_perc, 1), format='f', digits=1),"%"), paste0("did not change")))`.
<br>
...
``` {r pop_est_text3, echo=FALSE}

pop_est_perc_m <- sum(total_pop_est_gender$Number[total_pop_est_gender$Sex=="Male"])/sum(total_pop_est_gender$Number)*100
pop_est_perc_f <- sum(total_pop_est_gender$Number[total_pop_est_gender$Sex=="Female"])/sum(total_pop_est_gender$Number)*100

pop_est_perc_m_scotland <- sum(total_pop_est_gender_scotland$Number[total_pop_est_gender_scotland$Sex=="Male"])/sum(total_pop_est_gender_scotland$Number)*100
pop_est_perc_f_scotland <- sum(total_pop_est_gender_scotland$Number[total_pop_est_gender_scotland$Sex=="Female"])/sum(total_pop_est_gender_scotland$Number)*100

pop_est_gender_rank <- ifelse(pop_est_perc_f > pop_est_perc_m, "more females", ifelse(pop_est_perc_f < pop_est_perc_m, "fewer females", "equal")) 

pop_est_gender_rank_scotland <- ifelse(pop_est_perc_f_scotland > pop_est_perc_m_scotland, "more females", ifelse(pop_est_perc_f_scotland < pop_est_perc_m_scotland, "fewer females", "equal"))
                               
```

  In 
`r pop_est_end_year`, there were 
`r ifelse(pop_est_perc_f > pop_est_perc_m, paste0("more females (",formatC(round(pop_est_perc_f, 1), format='f', digits=1),"%) than males (",formatC(round(pop_est_perc_m, 1), format='f', digits=1),"%)"), ifelse(pop_est_perc_f < pop_est_perc_m, paste0("fewer females (",formatC(round(pop_est_perc_f, 1), format='f', digits=1),"%) than males (",formatC(round(pop_est_perc_m, 1), format='f', digits=1),"%)"), paste0("an equal number of females and males")))` living in 
`r paramsarea`. There were 
`r paste0(ifelse(pop_est_gender_rank == pop_est_gender_rank_scotland, "also", "contrastingly"))`
`r ifelse(pop_est_perc_f_scotland > pop_est_perc_m_scotland, paste0("more females (",formatC(round(pop_est_perc_f_scotland, 1), format='f', digits=1),"%) than males (",formatC(round(pop_est_perc_m_scotland, 1), format='f', digits=1),"%)"), ifelse(pop_est_perc_f_scotland < pop_est_perc_m_scotland, paste0("fewer females (",formatC(round(pop_est_perc_f_scotland, 1), format='f', digits=1),"%) than males (",formatC(round(pop_est_perc_m_scotland, 1), format='f', digits=1),"%)"), paste0("an equal number of females and males")))` living in Scotland overall.
<br>
...
``` {r pop_est_text4, echo=FALSE}

pop_est_age_sex_comp_current_min <- total_pop_est_age_sex_comp$Age_group[total_pop_est_age_sex_comp$Total == min(total_pop_est_age_sex_comp$Total)]

pop_est_age_sex_comp_current_max <- total_pop_est_age_sex_comp$Age_group[total_pop_est_age_sex_comp$Total == max(total_pop_est_age_sex_comp$Total)]

```

In terms of overall size, the 
`r pop_est_age_sex_comp_current_max` 
`r ifelse(length(pop_est_age_sex_comp_current_max) > 1, "age groups were", "age group was")` the largest in
`r pop_est_end_year`, with a population of 
`r format(total_pop_est_age_sex_comp$Total[total_pop_est_age_sex_comp$Total == max(total_pop_est_age_sex_comp$Total)][1], big.mark=",")`. In contrast, the 
`r pop_est_age_sex_comp_current_min`
`r ifelse(length(pop_est_age_sex_comp_current_min) > 1, "age groups were", "age group was")` the smallest, with a population of 
`r format(total_pop_est_age_sex_comp$Total[total_pop_est_age_sex_comp$Total == min(total_pop_est_age_sex_comp$Total)][1], big.mark=",")`. In 
`r pop_est_end_year`, more females than males lived in 
`r paramsarea` in 
`r sum(total_pop_est_age_sex_comp$Comparison)` out of 
`r nrow(total_pop_est_age_sex_comp)` age groups.
<br>
...
```{r pop_est_text5, echo=FALSE, warning = FALSE, fig.width=9, fig.align='right'}

pop_est_age_group_largest_positive_change <- total_pop_est_age_perc$Age_group[total_pop_est_age_perc$Perc == max(total_pop_est_age_perc$Perc)]

pop_est_age_group_largest_negative_change <- total_pop_est_age_perc$Age_group[total_pop_est_age_perc$Perc == min(total_pop_est_age_perc$Perc)]

pop_est_perc_largest_positive_change <- total_pop_est_age_perc$Perc[total_pop_est_age_perc$Perc == max(total_pop_est_age_perc$Perc)]

pop_est_perc_largest_negative_change <- total_pop_est_age_perc$Perc[total_pop_est_age_perc$Perc == min(total_pop_est_age_perc$Perc)]
...
`r pop_est_start_year` and 
`r pop_est_end_year`, 
`r ifelse(length(which(total_pop_est_age_perc$Sign == "negative")) <= 0.05, paste0("each age group increased in size. The ",pop_est_age_group_largest_positive_change," age group saw the largest percentage increase (+",formatC(round(pop_est_perc_largest_positive_change[1], 1), format='f', digits=1),"%)."), ifelse(length(which(total_pop_est_age_perc$Sign == "positive")) <= 0.05, paste0("each age group decreased in size. The ",pop_est_age_group_largest_negative_change," age group saw the largest percentage decrease (",formatC(round(pop_est_perc_largest_negative_change[1], 1), format='f', digits=1),"%)."), paste0("the ",pop_est_age_group_largest_negative_change," age group saw the largest percentage decrease (",formatC(round(pop_est_perc_largest_negative_change[1], 1), format='f', digits=1),"%). The ",pop_est_age_group_largest_positive_change," age group saw the largest percentage increase (+",formatC(round(pop_est_perc_largest_positive_change[1], 1), format='f', digits=1),"%).")))`
<br>
...
start_pop_proj <- total_pop_proj$Number[total_pop_proj$Area == paramsarea & total_pop_proj$Year == pop_proj_start_year]

end_pop_proj <- total_pop_proj$Number[total_pop_proj$Area == paramsarea & total_pop_proj$Year == pop_proj_end_year]

pop_proj_perc <- (end_pop_proj - start_pop_proj)/start_pop_proj*100

start_pop_proj_scot <- total_pop_proj$Number[total_pop_proj$Area == "Scotland" & total_pop_proj$Year == pop_proj_start_year]

end_pop_proj_scot <- total_pop_proj$Number[total_pop_proj$Area == "Scotland" & total_pop_proj$Year == pop_proj_end_year]

pop_proj_perc_scot <- (end_pop_proj_scot - start_pop_proj_scot)/start_pop_proj_scot*100
...
pop_proj_rank_text <- ifelse(pop_proj_rank_ca == min(total_pop_proj_end_year$Rank), paste0("highest"), 
ifelse(pop_proj_rank_ca == min(total_pop_proj_end_year$Rank)+1, paste0("2nd highest"),
ifelse(pop_proj_rank_ca == max(total_pop_proj_end_year$Rank), paste0("lowest"), 
ifelse(pop_proj_rank_ca == max(total_pop_proj_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(pop_proj_rank_ca == "22", paste0(pop_proj_rank_ca, "nd highest"),
ifelse(pop_proj_rank_ca %in% c("3","23"), paste0(pop_proj_rank_ca, "rd highest"),
ifelse(pop_proj_rank_ca == "21", paste0(pop_proj_rank_ca, "st highest"),               
paste0(pop_proj_rank_ca, "th highest"))))))))

pop_proj_rank_diff_ca <- total_pop_proj_end_year$Rank_change[total_pop_proj_end_year$Area == paramsarea]

pop_proj_rank_difference_text <- ifelse(pop_proj_rank_diff_ca == min(total_pop_proj_end_year$Rank_change), paste0("highest"), 
ifelse(pop_proj_rank_diff_ca == min(total_pop_proj_end_year$Rank_change)+1, paste0("2nd highest"),
ifelse(pop_proj_rank_diff_ca == max(total_pop_proj_end_year$Rank_change), paste0("lowest"), 
ifelse(pop_proj_rank_diff_ca == max(total_pop_proj_end_year$Rank_change)-1, paste0("2nd lowest"),
ifelse(pop_proj_rank_diff_ca == "22", paste0(pop_proj_rank_diff_ca, "nd highest"),
ifelse(pop_proj_rank_diff_ca %in% c("3","23"), paste0(pop_proj_rank_diff_ca, "rd highest"),
ifelse(pop_proj_rank_diff_ca == "21", paste0(pop_proj_rank_diff_ca, "st highest"),               
paste0(pop_proj_rank_diff_ca, "th highest"))))))))
...
pop_proj_natural_perc_ca <- pop_proj_nature$Natural_perc[pop_proj_nature$Area == paramsarea]

pop_proj_net_mig_ca <- pop_proj_nature$Mig_perc[pop_proj_nature$Area == paramsarea]
...
pop_proj_age_largest_increase <- total_pop_proj_age_perc$Age_group[total_pop_proj_age_perc$Sign == "positive" & total_pop_proj_age_perc$Rank_change == "1"]

pop_proj_age_largest_increase_perc <- total_pop_proj_age_perc$Perc[total_pop_proj_age_perc$Sign == "positive" & total_pop_proj_age_perc$Rank_change == "1"]

pop_proj_age_largest_decrease <- total_pop_proj_age_perc$Age_group[total_pop_proj_age_perc$Sign == "negative" & total_pop_proj_age_perc$Rank_change == "1"]

pop_proj_age_largest_decrease_perc <- total_pop_proj_age_perc$Perc[total_pop_proj_age_perc$Sign == "negative" & total_pop_proj_age_perc$Rank_change == "1"]

pop_proj_age_largest <- total_pop_proj_age_year$Age_group[total_pop_proj_age_year$Number == max(total_pop_proj_age_year$Number[total_pop_proj_age_year$Year == pop_proj_end_year])]

pop_proj_age_largest_start <- total_pop_proj_age_year$Age_group[total_pop_proj_age_year$Number == max(total_pop_proj_age_year$Number[total_pop_proj_age_year$Year == pop_proj_start_year])]
...
current_births <- total_births_sex$Number[total_births_sex$Sex == "All people" & total_births_sex$Year == bir_dea_marr_cp_est_end_year]

previous_births <- total_births_sex$Number[total_births_sex$Sex == "All people" & total_births_sex$Year == bir_dea_marr_cp_est_end_year-1]

births_perc <- (current_births - previous_births)/previous_births*100

current_births_f <- total_births_sex$Number[total_births_sex$Sex == "Female" & total_births_sex$Year == bir_dea_marr_cp_est_end_year]

current_births_m <- total_births_sex$Number[total_births_sex$Sex == "Male" & total_births_sex$Year == bir_dea_marr_cp_est_end_year]
...
births_rate_rank_text <- ifelse(births_rate_rank_ca == "1", paste0("highest"), 
ifelse(births_rate_rank_ca %in% c("2","22"), paste0(births_rate_rank_ca, "nd highest"),               ifelse(births_rate_rank_ca %in% c("3","23"), paste0(births_rate_rank_ca, "rd highest"),
ifelse(births_rate_rank_ca == "21", paste0(births_rate_rank_ca, "st highest"),               ifelse(births_rate_rank_ca == "32", paste0("lowest"), ifelse(births_rate_rank_ca == "31", paste0("2nd lowest"), paste0(births_rate_rank_ca, "th highest")))))))
...
mothers_age_most_common_current <- total_births_mothers_age_plot$Age_group[total_births_mothers_age_plot$Year == bir_dea_marr_cp_est_end_year & total_births_mothers_age_plot$Area == paramsarea & total_births_mothers_age_plot$Number == max(total_births_mothers_age_plot$Number[total_births_mothers_age_plot$Year == bir_dea_marr_cp_est_end_year & total_births_mothers_age_plot$Area == paramsarea])]

mothers_age_most_common_num <- total_births_mothers_age_plot$Number[total_births_mothers_age_plot$Age_group == mothers_age_most_common_current & total_births_mothers_age_plot$Year == bir_dea_marr_cp_est_end_year & total_births_mothers_age_plot$Area == paramsarea]

mothers_age_most_common_previous <- total_births_mothers_age_plot$Age_group[total_births_mothers_age_plot$Year == bir_dea_marr_est_start_year & total_births_mothers_age_plot$Area == paramsarea & total_births_mothers_age_plot$Number == max(total_births_mothers_age_plot$Number[total_births_mothers_age_plot$Year == bir_dea_marr_est_start_year & total_births_mothers_age_plot$Area == paramsarea])]

mothers_age_least_common_current <- total_births_mothers_age_plot$Age_group[total_births_mothers_age_plot$Year == bir_dea_marr_cp_est_end_year & total_births_mothers_age_plot$Area == paramsarea & total_births_mothers_age_plot$Number == min(total_births_mothers_age_plot$Number[total_births_mothers_age_plot$Year == bir_dea_marr_cp_est_end_year & total_births_mothers_age_plot$Area == paramsarea])]

mothers_age_least_common_num <- total_births_mothers_age_plot$Number[total_births_mothers_age_plot$Age_group == mothers_age_least_common_current & total_births_mothers_age_plot$Year == bir_dea_marr_cp_est_end_year & total_births_mothers_age_plot$Area == paramsarea]

mothers_age_least_common_previous <- total_births_mothers_age_plot$Age_group[total_births_mothers_age_plot$Year == bir_dea_marr_est_start_year & total_births_mothers_age_plot$Area == paramsarea & total_births_mothers_age_plot$Number == min(total_births_mothers_age_plot$Number[total_births_mothers_age_plot$Year == bir_dea_marr_est_start_year & total_births_mothers_age_plot$Area == paramsarea])]
...
mothers_age_group_largest_positive_change <- total_births_mothers_age_perc_plot$Age_group[total_births_mothers_age_perc_plot$Perc == max(total_births_mothers_age_perc_plot$Perc)]

mothers_age_group_largest_negative_change <- total_births_mothers_age_perc_plot$Age_group[total_births_mothers_age_perc_plot$Perc == min(total_births_mothers_age_perc_plot$Perc)]

mothers_perc_largest_positive_change <- total_births_mothers_age_perc_plot$Perc[total_births_mothers_age_perc_plot$Perc == max(total_births_mothers_age_perc_plot$Perc)]

mothers_perc_largest_negative_change <- total_births_mothers_age_perc_plot$Perc[total_births_mothers_age_perc_plot$Perc == min(total_births_mothers_age_perc_plot$Perc)]
...
current_fert_rate <- fert_rate$Number[fert_rate$Area == paramsarea & fert_rate$Year == bir_dea_marr_cp_est_end_year]

previous_fert_rate <- fert_rate$Number[fert_rate$Area == paramsarea & fert_rate$Year == bir_dea_marr_cp_est_end_year - 1]

fert_rate_change <- (current_fert_rate - previous_fert_rate)/previous_fert_rate*100

current_fert_rate_scotland <- fert_rate$Number[fert_rate$Area == "Scotland" & fert_rate$Year == bir_dea_marr_cp_est_end_year]

fert_rate_rank_ca <- fert_rate_end_year$Rank[fert_rate_end_year$Area == paramsarea]

fert_rate_rank_text <- ifelse(fert_rate_rank_ca == min(fert_rate_end_year$Rank), paste0("highest"),
ifelse(fert_rate_rank_ca == min(fert_rate_end_year$Rank)+1, paste0("2nd highest"),
ifelse(fert_rate_rank_ca == max(fert_rate_end_year$Rank), paste0("lowest"), 
ifelse(fert_rate_rank_ca == max(fert_rate_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(fert_rate_rank_ca == "22", paste0(fert_rate_rank_ca, "nd highest"),
ifelse(fert_rate_rank_ca %in% c("3","23"), paste0(fert_rate_rank_ca, "rd highest"),
ifelse(fert_rate_rank_ca == "21", paste0(fert_rate_rank_ca, "st highest"),               
paste0(fert_rate_rank_ca, "th highest"))))))))

num_fert_rate_increase <- nrow(fert_rate_end_year[fert_rate_end_year$Change_type=="increase",])

num_fert_rate_decrease <- nrow(fert_rate_end_year[fert_rate_end_year$Change_type=="decrease",])
...
current_deaths <- total_deaths_sex$Number[total_deaths_sex$Sex == "All people" & total_deaths_sex$Year == bir_dea_marr_cp_est_end_year]

previous_deaths <- total_deaths_sex$Number[total_deaths_sex$Sex == "All people" & total_deaths_sex$Year == bir_dea_marr_cp_est_end_year-1]

deaths_perc <- (current_deaths - previous_deaths)/previous_deaths*100

current_deaths_f <- total_deaths_sex$Number[total_deaths_sex$Sex == "Female" & total_deaths_sex$Year == bir_dea_marr_cp_est_end_year]

current_deaths_m <- total_deaths_sex$Number[total_deaths_sex$Sex == "Male" & total_deaths_sex$Year == bir_dea_marr_cp_est_end_year]
...
current_death_rate <- deaths_rate$Number[deaths_rate$Area == paramsarea & deaths_rate$Year == bir_dea_marr_cp_est_end_year]

previous_death_rate <- deaths_rate$Number[deaths_rate$Area == paramsarea & deaths_rate$Year == bir_dea_marr_cp_est_end_year - 1]

current_death_rate_scotland <- deaths_rate$Number[deaths_rate$Area == "Scotland" & deaths_rate$Year == bir_dea_marr_cp_est_end_year]

previous_death_rate_scotland <- deaths_rate$Number[deaths_rate$Area == "Scotland" & deaths_rate$Year == bir_dea_marr_cp_est_end_year - 1]

deaths_rate_rank_ca <- deaths_rate_end_year$Rank[deaths_rate_end_year$Area == paramsarea]
...
num_deaths_rate_increase <- nrow(deaths_rate_end_year[deaths_rate_end_year$Change_type=="increase",])
num_deaths_rate_decrease <- nrow(deaths_rate_end_year[deaths_rate_end_year$Change_type=="decrease",])
num_deaths_rate_equal <- nrow(deaths_rate_end_year[deaths_rate_end_year$Change_type=="equal",])
...
deaths_change_type_f <- total_deaths_sex_perc$Sign[total_deaths_sex_perc$Sex == "Female"]
deaths_change_type_m <- total_deaths_sex_perc$Sign[total_deaths_sex_perc$Sex == "Male"]

deaths_f <- total_deaths_sex_comp$Number[total_deaths_sex_comp$Sex == "Female" & total_deaths_sex_comp$Year == bir_dea_marr_cp_est_end_year]

deaths_m <- total_deaths_sex_comp$Number[total_deaths_sex_comp$Sex == "Male" & total_deaths_sex_comp$Year == bir_dea_marr_cp_est_end_year]
...
deaths_change_f <- total_deaths_sex_perc$Perc[total_deaths_sex_perc$Sex == "Female"]
deaths_change_m <- total_deaths_sex_perc$Perc[total_deaths_sex_perc$Sex == "Male"]

deaths_change_f_scotland <- total_deaths_sex_perc_scotland$Perc[total_deaths_sex_perc_scotland$Sex == "Female"]
deaths_change_m_scotland <- total_deaths_sex_perc_scotland$Perc[total_deaths_sex_perc_scotland$Sex == "Male"]
...
most_deaths_age_group <- total_deaths_age$Age_group[total_deaths_age$Number == max(total_deaths_age$Number)]

fewest_deaths_age_group <- total_deaths_age$Age_group[total_deaths_age$Number == min(total_deaths_age$Number)]

most_deaths <- total_deaths_age$Number[total_deaths_age$Number == max(total_deaths_age$Number)]
fewest_deaths <- total_deaths_age$Number[total_deaths_age$Number == min(total_deaths_age$Number)]

most_deaths_f_age_group <- total_deaths_age_sex$Age_group[total_deaths_age_sex$Number == max(total_deaths_age_sex$Number[total_deaths_age_sex$Sex == "Female"]) & total_deaths_age_sex$Sex == "Female"]

most_deaths_f <- total_deaths_age_sex$Number[total_deaths_age_sex$Number == max(total_deaths_age_sex$Number[total_deaths_age_sex$Sex == "Female"]) & total_deaths_age_sex$Sex == "Female"]

most_deaths_m_age_group <- total_deaths_age_sex$Age_group[total_deaths_age_sex$Number == max(total_deaths_age_sex$Number[total_deaths_age_sex$Sex == "Male"]) & total_deaths_age_sex$Sex == "Male"]

most_deaths_m <- total_deaths_age_sex$Number[total_deaths_age_sex$Number == max(total_deaths_age_sex$Number[total_deaths_age_sex$Sex == "Male"]) & total_deaths_age_sex$Sex == "Male"]
...
le_birth_f_perc_rank_text <- ifelse(le_birth_f_perc_rank_ca == min(life_exp_from_birth_f_end_year$Rank), paste0("highest"), 
ifelse(le_birth_f_perc_rank_ca == min(life_exp_from_birth_f_end_year$Rank)+1, paste0("2nd highest"),
ifelse(le_birth_f_perc_rank_ca == max(life_exp_from_birth_f_end_year$Rank), paste0("lowest"), 
ifelse(le_birth_f_perc_rank_ca == max(life_exp_from_birth_f_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(le_birth_f_perc_rank_ca == "22", paste0(le_birth_f_perc_rank_ca, "nd highest"),
ifelse(le_birth_f_perc_rank_ca %in% c("3","23"), paste0(le_birth_f_perc_rank_ca, "rd highest"),
ifelse(le_birth_f_perc_rank_ca == "21", paste0(le_birth_f_perc_rank_ca, "st highest"),               
paste0(le_birth_f_perc_rank_ca, "th highest"))))))))

le_birth_m_perc_rank_ca <- life_exp_from_birth_m_end_year$Rank[life_exp_from_birth_m_end_year$Area == paramsarea]

le_birth_m_perc_rank_text <- ifelse(le_birth_m_perc_rank_ca == min(life_exp_from_birth_m_end_year$Rank), paste0("highest"), 
ifelse(le_birth_m_perc_rank_ca == min(life_exp_from_birth_m_end_year$Rank)+1, paste0("2nd highest"),
ifelse(le_birth_m_perc_rank_ca == max(life_exp_from_birth_m_end_year$Rank), paste0("lowest"), 
ifelse(le_birth_m_perc_rank_ca == max(life_exp_from_birth_m_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(le_birth_m_perc_rank_ca == "22", paste0(le_birth_m_perc_rank_ca, "nd highest"),
ifelse(le_birth_m_perc_rank_ca %in% c("3","23"), paste0(le_birth_m_perc_rank_ca, "rd highest"),
ifelse(le_birth_m_perc_rank_ca == "21", paste0(le_birth_m_perc_rank_ca, "st highest"),               
paste0(le_birth_m_perc_rank_ca, "th highest"))))))))
...
le_at_65_f_perc_rank_text <- ifelse(le_at_65_f_perc_rank_ca == min(life_exp_at_65_f_end_year$Rank), paste0("highest"), 
ifelse(le_at_65_f_perc_rank_ca == min(life_exp_at_65_f_end_year$Rank)+1, paste0("2nd highest"),
ifelse(le_at_65_f_perc_rank_ca == max(life_exp_at_65_f_end_year$Rank), paste0("lowest"), 
ifelse(le_at_65_f_perc_rank_ca == max(life_exp_at_65_f_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(le_at_65_f_perc_rank_ca == "22", paste0(le_at_65_f_perc_rank_ca, "nd highest"),
ifelse(le_at_65_f_perc_rank_ca %in% c("3","23"), paste0(le_at_65_f_perc_rank_ca, "rd highest"),
ifelse(le_at_65_f_perc_rank_ca == "21", paste0(le_at_65_f_perc_rank_ca, "st highest"),               
paste0(le_at_65_f_perc_rank_ca, "th highest"))))))))

le_at_65_m_perc_rank_ca <- life_exp_at_65_m_end_year$Rank[life_exp_at_65_m_end_year$Area == paramsarea]

le_at_65_m_perc_rank_text <- ifelse(le_at_65_m_perc_rank_ca == min(life_exp_at_65_m_end_year$Rank), paste0("highest"), 
ifelse(le_at_65_m_perc_rank_ca == min(life_exp_at_65_m_end_year$Rank)+1, paste0("2nd highest"),
ifelse(le_at_65_m_perc_rank_ca == max(life_exp_at_65_m_end_year$Rank), paste0("lowest"), 
ifelse(le_at_65_m_perc_rank_ca == max(life_exp_at_65_m_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(le_at_65_m_perc_rank_ca == "22", paste0(le_at_65_m_perc_rank_ca, "nd highest"),
ifelse(le_at_65_m_perc_rank_ca %in% c("3","23"), paste0(le_at_65_m_perc_rank_ca, "rd highest"),
ifelse(le_at_65_m_perc_rank_ca == "21", paste0(le_at_65_m_perc_rank_ca, "st highest"),               
paste0(le_at_65_m_perc_rank_ca, "th highest"))))))))
...
net_mig_rank_text <- ifelse(net_mig_rank_ca == min(net_mig_end_year$Rank), paste0("highest"), 
ifelse(net_mig_rank_ca == min(net_mig_end_year$Rank)+1, paste0("2nd highest"),
ifelse(net_mig_rank_ca == max(net_mig_end_year$Rank), paste0("lowest"), 
ifelse(net_mig_rank_ca == max(net_mig_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(net_mig_rank_ca == "22", paste0(net_mig_rank_ca, "nd highest"),
ifelse(net_mig_rank_ca %in% c("3","23"), paste0(net_mig_rank_ca, "rd highest"),
ifelse(net_mig_rank_ca == "21", paste0(net_mig_rank_ca, "st highest"),   
paste0(net_mig_rank_ca, "th highest"))))))))
...
net_mig_rate_rank_text <- ifelse(net_mig_rate_rank_ca == min(net_mig_rates_end_year$Rank), paste0("highest"), 
ifelse(net_mig_rate_rank_ca == min(net_mig_rates_end_year$Rank)+1, paste0("2nd highest"),
ifelse(net_mig_rate_rank_ca == max(net_mig_rates_end_year$Rank), paste0("lowest"), 
ifelse(net_mig_rate_rank_ca == max(net_mig_rates_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(net_mig_rate_rank_ca == "22", paste0(net_mig_rate_rank_ca, "nd highest"),
ifelse(net_mig_rate_rank_ca %in% c("3","23"), paste0(net_mig_rate_rank_ca, "rd highest"),
ifelse(net_mig_rate_rank_ca == "21", paste0(net_mig_rate_rank_ca, "st highest"),               
paste0(net_mig_rate_rank_ca, "th highest"))))))))
...
marr_rank_text <- ifelse(marr_rank_ca == min(marr_end_year$Rank), paste0("highest"), 
ifelse(marr_rank_ca == min(marr_end_year$Rank)+1, paste0("2nd highest"),
ifelse(marr_rank_ca == max(marr_end_year$Rank), paste0("lowest"), 
ifelse(marr_rank_ca == max(marr_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(marr_rank_ca == "22", paste0(marr_rank_ca, "nd highest"),
ifelse(marr_rank_ca %in% c("3","23"), paste0(marr_rank_ca, "rd highest"),
ifelse(marr_rank_ca == "21", paste0(marr_rank_ca, "st highest"),               
paste0(marr_rank_ca, "th highest"))))))))
...
cp_rank_text <- ifelse(cp_rank_ca == min(cp_end_year$Rank), paste0("highest"), 
ifelse(cp_rank_ca == min(cp_end_year$Rank)+1, paste0("2nd highest"),
ifelse(cp_rank_ca == max(cp_end_year$Rank), paste0("lowest"), 
ifelse(cp_rank_ca == max(cp_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(cp_rank_ca == "22", paste0(cp_rank_ca, "nd highest"),
ifelse(cp_rank_ca %in% c("3","23"), paste0(cp_rank_ca, "rd highest"),
ifelse(cp_rank_ca == "21", paste0(cp_rank_ca, "st highest"),               
paste0(cp_rank_ca, "th highest"))))))))
...
house_est_rank_text <- ifelse(house_est_rank_ca == min(house_est_end_year_data$Rank), paste0("highest"), 
ifelse(house_est_rank_ca == min(house_est_end_year_data$Rank)+1, paste0("2nd highest"),
ifelse(house_est_rank_ca == max(house_est_end_year_data$Rank), paste0("lowest"), 
ifelse(house_est_rank_ca == max(house_est_end_year_data$Rank)-1, paste0("2nd lowest"),
ifelse(house_est_rank_ca == "22", paste0(house_est_rank_ca, "nd highest"),
ifelse(house_est_rank_ca %in% c("3","23"), paste0(house_est_rank_ca, "rd highest"),
ifelse(house_est_rank_ca == "21", paste0(house_est_rank_ca, "st highest"),               
paste0(house_est_rank_ca, "th highest"))))))))
...
house_est_rank_perc_text <- ifelse(house_est_rank_perc_ca == min(house_est_end_year_data$Rank_perc), paste0("highest"), 
ifelse(house_est_rank_perc_ca == min(house_est_end_year_data$Rank_perc)+1, paste0("2nd highest"),
ifelse(house_est_rank_perc_ca == max(house_est_end_year_data$Rank_perc), paste0("lowest"), 
ifelse(house_est_rank_perc_ca == max(house_est_end_year_data$Rank_perc)-1, paste0("2nd lowest"),
ifelse(house_est_rank_perc_ca == "22", paste0(house_est_rank_perc_ca, "nd highest"),
ifelse(house_est_rank_perc_ca %in% c("3","23"), paste0(house_est_rank_perc_ca, "rd highest"),
ifelse(house_est_rank_perc_ca == "21", paste0(house_est_rank_perc_ca, "st highest"),               
paste0(house_est_rank_perc_ca, "th highest"))))))))
...
house_proj_rank_text <- ifelse(house_proj_rank_ca == min(house_proj_end_year_dataset$Rank), paste0("highest"), 
ifelse(house_proj_rank_ca == min(house_proj_end_year_dataset$Rank)+1, paste0("2nd highest"),
ifelse(house_proj_rank_ca == max(house_proj_end_year_dataset$Rank), paste0("lowest"), 
ifelse(house_proj_rank_ca == max(house_proj_end_year_dataset$Rank)-1, paste0("2nd lowest"),
ifelse(house_proj_rank_ca == "22", paste0(house_proj_rank_ca, "nd highest"),
ifelse(house_proj_rank_ca %in% c("3","23"), paste0(house_proj_rank_ca, "rd highest"),
ifelse(house_proj_rank_ca == "21", paste0(house_proj_rank_ca, "st highest"),               
paste0(house_proj_rank_ca, "th highest"))))))))
...
house_proj_rank_perc_text <- ifelse(house_proj_rank_perc_ca == min(house_proj_end_year_dataset$Rank_perc), paste0("highest"), 
ifelse(house_proj_rank_perc_ca == min(house_proj_end_year_dataset$Rank_perc)+1, paste0("2nd highest"),
ifelse(house_proj_rank_perc_ca == max(house_proj_end_year_dataset$Rank_perc), paste0("lowest"), 
ifelse(house_proj_rank_perc_ca == max(house_proj_end_year_dataset$Rank_perc)-1, paste0("2nd lowest"),
ifelse(house_proj_rank_perc_ca == "22", paste0(house_proj_rank_perc_ca, "nd highest"),
ifelse(house_proj_rank_perc_ca %in% c("3","23"), paste0(house_proj_rank_perc_ca, "rd highest"),
ifelse(house_proj_rank_perc_ca == "21", paste0(house_proj_rank_perc_ca, "st highest"),               
paste0(house_proj_rank_perc_ca, "th highest"))))))))
...
current_dwell <- total_dwell_num$Number[total_dwell_num$Area == paramsarea & total_dwell_num$Year == dwell_est_end_year]

previous_dwell <- total_dwell_num$Number[total_dwell_num$Area == paramsarea & total_dwell_num$Year == dwell_est_end_year - 1]

dwell_perc <- (current_dwell - previous_dwell)/previous_dwell*100

current_dwell_scotland <- total_dwell_num$Number[total_dwell_num$Area == "Scotland" & total_dwell_num$Year == dwell_est_end_year]

previous_dwell_scotland <- total_dwell_num$Number[total_dwell_num$Area == "Scotland" & total_dwell_num$Year == dwell_est_end_year - 1]

dwell_perc_scotland <- (current_dwell_scotland - previous_dwell_scotland)/previous_dwell_scotland*100

dwell_rank_ca <- dwell_end_year$Rank[dwell_end_year$Area == paramsarea]
...
dwell_rank_text <- ifelse(dwell_rank_ca == min(dwell_end_year$Rank), paste0("highest"), 
ifelse(dwell_rank_ca == min(dwell_end_year$Rank)+1, paste0("2nd highest"),
ifelse(dwell_rank_ca == max(dwell_end_year$Rank), paste0("lowest"), 
ifelse(dwell_rank_ca == max(dwell_end_year$Rank)-1, paste0("2nd lowest"),
ifelse(dwell_rank_ca == "22", paste0(dwell_rank_ca, "nd highest"),
ifelse(dwell_rank_ca %in% c("3","23"), paste0(dwell_rank_ca, "rd highest"),
ifelse(dwell_rank_ca == "21", paste0(dwell_rank_ca, "st highest"),               
paste0(dwell_rank_ca, "th highest"))))))))
...
dwell_rank_perc_text <- ifelse(dwell_rank_perc_ca == min(dwell_end_year$Rank_perc), paste0("highest"), 
ifelse(dwell_rank_perc_ca == min(dwell_end_year$Rank_perc)+1, paste0("2nd highest"),
ifelse(dwell_rank_perc_ca == max(dwell_end_year$Rank_perc), paste0("lowest"), 
ifelse(dwell_rank_perc_ca == max(dwell_end_year$Rank_perc)-1, paste0("2nd lowest"),
ifelse(dwell_rank_perc_ca == "22", paste0(dwell_rank_perc_ca, "nd highest"),
ifelse(dwell_rank_perc_ca %in% c("3","23"), paste0(dwell_rank_perc_ca, "rd highest"),
ifelse(dwell_rank_perc_ca == "21", paste0(dwell_rank_perc_ca, "st highest"),               
paste0(dwell_rank_perc_ca, "th highest"))))))))
